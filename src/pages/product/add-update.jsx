...
class ProductAddUpdate extends Component {
    ...
    /**
     * 异步获取一级/二级分类列表，并显示
     * async 函数的返回值是一个新的promise对象，promise的结果和值由async的结果来决定的
     */
    ...
    componentWillMount() {
        // 取出携带的state
        const product = this.props.location.state // 如果是添加没有携带的数据，则修改有
        // 保存是否是修改的标识
        this.isUpdate = !!product
        // 保存商品，如果没有，保存{}空对象，避免添加是报错
 ...
 * 父组件调用子组件的方法：将父组件中通过ref得到子组件标签对象(也就是组件对象)，调用其方法
 */